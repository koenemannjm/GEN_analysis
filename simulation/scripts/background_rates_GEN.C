...
#include <fstream>
#include "TGraph.h"
#include "/work/halla/sbs/jeffas/SBS_GEANT/g4sbs/install/root_macros/gen_tree.C"
#include "TRandom3.h"

const double me = 0.511e-3;

void background_rates_GEN( int Q2 = 29 ){
  ...
  TString outfilename = Form("Rootfiles/GEN_background_rates_%i_GeV.root",Q2);
