...
setenv DATA_DIR /cache/halla/sbs/GEnII/raw
#setenv DATA_DIR /volatile/halla/sbs/jeffas/GMN_root/raw
setenv OUT_DIR /volatile/halla/sbs/jeffas/GEN_root/Rootfiles/GEM_luminosity/zero_suppressed
...
#analyzer -q
analyzer  -q 'replay_gen.C+('$runnum','$maxevents','$firstevent','\"$prefix\"','$firstsegment','$maxsegments',2,0,0,'$sbs_gems')'
