...
void replay_run(TString cfg = "GEN3"){
  

  TFile *file;
  TFile *file_new;

  file = new TFile("../outfiles/QE_data_" + cfg + "_sbs100p_nucleon_p_model1.root","read");
  file_new = new TFile("../outfiles/QE_new_matrix_" + cfg + "_sbs100p_nucleon_p_model1.root","recreate");
  ...
  if( cfg == "GEN3"){
    Matrix_filename = "optics_gen3_beam.txt";
